...
| Profiles + KFAM | apps/profiles/upstream | [v1.7.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.7.0-rc.1/components/profile-controller/config) |
| PodDefaults Webhook | apps/admission-webhook/upstream | [v1.7.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.7.0-rc.1/components/admission-webhook/manifests) |
...
```sh
kustomize build apps/pipeline/upstream/env/cert-manager/platform-agnostic-multi-user | awk '!/well-defined/' | sed -e 's/mage: /mage: projects.registry.vmware.com\/kubeflow\/cache\//' -e 's/\"gcr/\"projects.registry.vmware.com\/kubeflow\/cache\/gcr/' | kubectl apply -f -
```
